      ...
      <AnimatePresence>
        {isDropdownOpen && (
          <motion.div
            ...
            className="glass-card absolute left-0 top-full z-50 mt-2 w-64 rounded-2xl p-2 shadow-2xl shadow-navy-900/10"
          >
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden items-center gap-6 lg:flex">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-b from-teal-600 to-teal-700 px-6 py-2.5 text-sm font-semibold text-white shadow-lg shadow-teal-600/20 transition-all hover:shadow-xl hover:shadow-teal-600/30 hover:brightness-110"
          >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="glass overflow-hidden border-t border-navy-200/50 lg:hidden"
          >
            <div className="space-y-1 px-4 py-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-2 flex items-center justify-center gap-2 rounded-full bg-gradient-to-b from-teal-600 to-teal-700 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-600/20 transition-all hover:shadow-xl hover:shadow-teal-600/30"
              >
