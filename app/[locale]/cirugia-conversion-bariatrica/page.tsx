...
export async function generateMetadata({ params }: PageProps) {
  ...
  const procedureData = getProcedureBySlug("cirugia-conversion-bariatrica", locale as Locale);
  if (!procedureData) return {};

  return createPageMetadata({
    title: procedureData.metaTitle,
    description: procedureData.metaDescription,
    path: "/cirugia-conversion-bariatrica",
    locale: locale as Locale,
    alternateLocalePath: "/cirugia-conversion-bariatrica",
    ogImage: "/images/og-bariatrica.png",
  });
}

export default async function CirugiaConversionBariatricaPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const breadcrumbJsonLd = generateBreadcrumbJsonLd([
    ...
    { name: procedureData.title, url: `${DOCTOR_INFO.siteUrl}/${locale}/cirugia-conversion-bariatrica` },
  ]);
  ...
  return (
    <>
      ...
      <MedicalDisclaimer />
      <RelatedProcedures currentHref="/cirugia-conversion-bariatrica" />
      <CTASection
        heading={t("cirugiaConversionBariatrica.ctaHeading")}
        description={t("cirugiaConversionBariatrica.ctaDescription")}
        variant="teal"
      />
