...
export async function generateMetadata({ params }: PageProps) {
  ...
  const procedureData = getProcedureBySlug("apendicectomia-laparoscopica", locale as Locale);
  ...
  return createPageMetadata({
    ...
    alternateLocalePath: "/apendicectomia-laparoscopica",
    ogImage: "/images/og-minima-invasion.png",
  });
}

export default async function ApendicectomiaLaparoscopicaPage({ params }: PageProps) {
  const { locale } = await params;
  ...
  const breadcrumbJsonLd = generateBreadcrumbJsonLd([
    ...
    { name: procedureData.title, url: `${DOCTOR_INFO.siteUrl}/${locale}/apendicectomia-laparoscopica` },
  ]);
  ...
  return (
    <>
      ...
      <MedicalDisclaimer />
      <RelatedProcedures currentHref="/apendicectomia-laparoscopica" />
      <CTASection
        heading={t("apendicectomiaLaparoscopica.ctaHeading")}
        description={t("apendicectomiaLaparoscopica.ctaDescription")}
        variant="teal"
      />
